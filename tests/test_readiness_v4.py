...
from app.core.readiness import compute_readiness_score, compute_recent_fatigue, workout_type_from_readiness
...
def _activity(duration_min, avg_hr, max_hr=0, hours_ago=12):
